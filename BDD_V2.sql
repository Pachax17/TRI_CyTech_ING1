...
-- Table Relation entre Centre de Tri et Poubelle Intelligente
CREATE TABLE IF NOT EXISTS centre_poubelle (
    id_centre INT,
    id_poubelle INT,
    PRIMARY KEY (id_centre, id_poubelle),
    FOREIGN KEY (id_centre) REFERENCES centre_de_tri(id) ON DELETE CASCADE,
    FOREIGN KEY (id_poubelle) REFERENCES poubelle_intelligente(id) ON DELETE CASCADE
);
